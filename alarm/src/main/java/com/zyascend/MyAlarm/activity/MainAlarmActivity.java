        ...
        public void onBindViewHolder(MyViewHolder holder, final int position) {
            ...
            holder.mOverFlowImage.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    cancelAlarm(MainAlarmActivity.this, id, alarm);

                    Toast.makeText(MainAlarmActivity.this, "已删除闹钟", Toast.LENGTH_SHORT).show();
...
//            PopupMenu menu = new PopupMenu(MainAlarmActivity.this, v);
...
//        }
                ...
                mActiveImage.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (item.mActive.equals("true")) {
                            ...
                            cancelAlarm(MainAlarmActivity.this, CheckedAlarmID, alarmModel);
                            Toast.makeText(MainAlarmActivity.this, "已关闭闹钟", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(MainAlarmActivity.this, "已开启闹钟", Toast.LENGTH_SHORT).show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (i1 == R.id.action_finish) {
            finish();

        } else if (i1 == R.id.action_about) {
